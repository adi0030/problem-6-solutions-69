      ...
      >
        <div className="space-y-8">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-slate-600 dark:text-slate-400 md:text-xl">
            A quiet corner of the internet for meaningful connections. 
            No ads, no algorithmic noise, just you and your people.
          </p>
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <motion.button
              ...
              className="group flex items-center gap-3 rounded-full bg-slate-900 px-8 py-4 text-base font-bold text-white shadow-xl transition-all hover:bg-slate-800 hover:shadow-2xl dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
            >
