  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      <motion.div 
        ...
        className="z-10 mx-auto flex max-w-3xl flex-col items-center gap-10 p-6 text-center"
      >
        <div className="space-y-6">
          ...
          <h1 className="text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white md:text-7xl lg:text-8xl">
            Gather <span className="text-slate-400 dark:text-slate-500">around.</span>
          </h1>
          <p className="mx-auto max-w-xl text-lg leading-relaxed text-slate-600 dark:text-slate-400 md:text-xl">
            A quiet corner of the internet for posts, comments, and emoji-only chat. 
            Connect with friends without the noise.
          </p>
        </div>
        ...
        <motion.button
          ...
          className="group flex items-center gap-3 rounded-full bg-slate-900 px-8 py-4 text-base font-semibold text-white shadow-xl transition-all hover:bg-slate-800 hover:shadow-2xl dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
        >
